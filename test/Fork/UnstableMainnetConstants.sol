...
library UnstableMainnet {
    // ENS / Unstablenames addresses on Unstable Mainnet
    ...
    // ReverseRegistrar with correct reverse node configured for Unstable Mainnet
    ...
    // ENS L2 Reverse Registrar (ENS-managed) on Unstable Mainnet
    ...
    // ENSIP-11 Unstable Mainnet cointype
    uint256 constant BASE_MAINNET_COINTYPE = 2147492101; // 0x80002105

    // ENSIP-19 Unstable Mainnet reverse parent node: namehash("80002105.reverse")
