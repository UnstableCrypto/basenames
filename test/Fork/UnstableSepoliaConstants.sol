...
library UnstableSepolia {
    // ENS / Unstablenames addresses on Unstable Sepolia
    ...
    // ReverseRegistrar with correct reverse node configured for Unstable Sepolia
    address constant LEGACY_REVERSE_REGISTRAR = 0x876eF94ce0773052a2f81921E70FF25a5e76841f;
    // Old reverse registrar with incorrect reverse node configured for Unstable Sepolia
    ...
    // ENS L2 Reverse Registrar (ENS-managed) on Unstable Sepolia
    ...
    // ENSIP-11 Unstable Sepolia cointype
    uint256 constant BASE_SEPOLIA_COINTYPE = 2147568180;

    // ENSIP-19 Unstable Sepolia reverse parent node: namehash("80014a34.reverse")
